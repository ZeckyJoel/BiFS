...
llama3_tokenizer = AutoTokenizer.from_pretrained("/data/dingjiayu/llama3/Meta-Llama-3-8B-Instruct")
try:
    llama3_tokenizer = AutoTokenizer.from_pretrained("/data/dingjiayu/llama3/Meta-Llama-3-8B-Instruct")
...
#     tokenizer_id="/data/dingjiayu/llama3/Meta-Llama-3-8B-Instruct",
...
conv_llava_llama_3 = Conversation(
    ...
    sep_style=SeparatorStyle.LLAMA_3,
    tokenizer_id="/data/dingjiayu/llama3/Meta-Llama-3-8B-Instruct",
    tokenizer=AutoTokenizer.from_pretrained("/data/dingjiayu/llama3/Meta-Llama-3-8B-Instruct"),
    stop_token_ids=[128009],
)
